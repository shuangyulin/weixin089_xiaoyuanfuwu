     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='maijia'"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling"               placeholder="年龄" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='maijia'"  label="身份证号码" prop="shenfenzhenghaoma">
          <el-input v-model="ruleForm.shenfenzhenghaoma"               placeholder="身份证号码" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='maijia'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="24">  
        <el-form-item v-if="flag=='maijia'" label="相片" prop="xiangpian">
          <file-upload
          tip="点击上传相片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.xiangpian?ruleForm.xiangpian:''"
          @change="maijiaxiangpianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='maijia'"  label="卖家地址" prop="maijiadizhi">
          <el-input v-model="ruleForm.maijiadizhi"               placeholder="卖家地址" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
        ...
        this.ruleForm.xiangpian = fileUrls;
                                                                                                ...
                                                                                                maijiaxiangpianUploadChange(fileUrls) {
        this.ruleForm.xiangpian = fileUrls;
    },
                                                            onUpdateHandler() {
       ...
       this.$message.error(`年龄应输入整数`);
        ...
        return
                                                                                                                              ...
                                                                                                                              if( 'maijia' ==this.flag && this.ruleForm.nianling&&(!isIntNumer(this.ruleForm.nianling))){
       this.$message.error(`年龄应输入整数`);
        return
      }
                                                                                                if( 'maijia' ==this.flag && this.ruleForm.shenfenzhenghaoma&&(!checkIdCard(this.ruleForm.shenfenzhenghaoma))){
        this.$message.error(`身份证号码应输入身份证格式`);
        return
      }
